...
class ManageBankCard {
  final ManageBankCardRepository _manageBankCardRepository = ManageBankCardsRepositoryImpl();
  ...
  Future<List<CardEntity>> getAllCards () async {
    final List<CardEntity> allCards = await _manageBankCardRepository.getAllCards();
    allCards.sort((a, b) {
