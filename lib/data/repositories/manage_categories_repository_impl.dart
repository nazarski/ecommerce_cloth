...
class ManageCategoriesRepositoryImpl implements ManageCategoriesRepository{
  ...
  @override
  Future<List<CategoryEntity>> getCategoriesFromAttribute(String attribute) async{
    // try {
      final listOfCategoryIds = await ManageCategoriesData.getAvailableCategories(attribute);
      final listOfCategories = await ManageCategoriesData.getCategories(listOfCategoryIds!);
