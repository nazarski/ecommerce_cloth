...
class BottomSheetResetPassword extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _BottomSheetResetPasswordState();
}

class _BottomSheetResetPasswordState
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(resetPasswordProvider, (previous, next) {
      if (next.hasError) {
        topSnackBar(
            context: context,
            label: 'Oops, you have entered an incorrect current password');
      }
      if (next.value != null && next.value!) {
        Navigator.of(context).pop();
        topSnackBar(
            context: context, label: 'Super! Password changed successfully');
      }
    });
